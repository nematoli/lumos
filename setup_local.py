"""Setup lumos installation for SLURM environments."""
...
meta = dict(
    ...
    description="LUMOS: Language-Conditioned Imitation Learning with World Models",
    platforms=("Any"),
    zip_safe=False,
    keywords="pytorch lumos".split(),
    author=find_meta(_meta, "__author__"),
    author_email=find_meta(_meta, "__email__"),
    url="https://github.com/nematoli/lumos",
